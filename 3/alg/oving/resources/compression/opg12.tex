...
Huffmannkoding på output fra Lempel-Ziv.
...
er avtalt på forhånd. Lempel-Ziv-Welsh (LZW) er en annen algoritme.
...
\item Programmene må lese og skrive filer. Altså ikke bare testdata i en
tabell.
...
så den tar mindre plass \textendash{} og pakke den ut igjen også. 
...
også \textendash{} så lenge de ikke er for trege til å demonstreres.
Noe bitfikling blir det uansett med Huffmannoppgaven. Det går ikke
an å skrive <<en halv byte>> til fil, man må i det minste samle

...
class AtTime implements Comparable<AtTime> {
	private final long tid; // format ååååmmddttmm

	public AtTime(long tid) {
		this.tid = tid;
	}
	...
	public int compareTo(AtTime detAndre) {
		if (tid < detAndre.tid) {
			return -1;
	...
	public static void main(String[] args) {
		...
		AtTime t1 = new AtTime(200301201200L);
		AtTime t2 = new AtTime(200301070230L);
		AtTime t3 = new AtTime(200301070230L);
